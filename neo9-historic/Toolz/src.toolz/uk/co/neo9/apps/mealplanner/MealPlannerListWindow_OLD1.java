 ...
 */
public class MealPlannerListWindow_OLD1 extends JPanel {
    private boolean DEBUG = false;

    public MealPlannerListWindow_OLD1() {
...
//        table.setPreferredScrollableViewportSize(new Dimension(500, 70));
    ...
    private static void createAndShowGUI() {
        ...
        MealPlannerListWindow_OLD1 newContentPane = new MealPlannerListWindow_OLD1();
