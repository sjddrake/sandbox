...
public class BarclaysCSVExportCommand extends CreditCardBFPBaseCommand {

	private int focusAccountId;
	
	public BarclaysCSVExportCommand() {
		super();
		setInputFileType(AccountsDataModel.IFT_BARCLAYS_CSV_EXPORT);
	}
