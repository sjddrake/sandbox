 ...
 */
public final class BudgetDiaryCommonConstants {
    ...
    public static Collection<String> getAllMonthNamesShort() {

    	Collection<String> monthNames;
        monthNames = (Collection<String>) monthNamesShort.values();

        return monthNames;
    }


    public static String decodeMonthID_English(int month, boolean useZeroBasedIndex) {

        String monthName;
        if (useZeroBasedIndex) {
            monthName = decodeMonthID_English(month);
        } else {
            monthName = decodeMonthID_English(month - 1);
        }
        return monthName;
    }
    ...
    public static String decodeMonthID_English(int month) {
        ...
        switch (month) {
            case Calendar.JANUARY:
                monthName = MONTH_NAME_FULL_JANUARY;
                break;
            case Calendar.FEBRUARY:
                monthName = MONTH_NAME_FULL_FEBRUARY;
                break;
            case Calendar.MARCH:
                monthName = MONTH_NAME_FULL_MARCH;
                break;
            case Calendar.APRIL:
                monthName = MONTH_NAME_FULL_APRIL;
                break;
            case Calendar.MAY:
                monthName = MONTH_NAME_FULL_MAY;
                break;
            case Calendar.JUNE:
                monthName = MONTH_NAME_FULL_JUNE;
                break;
            case Calendar.JULY:
                monthName = MONTH_NAME_FULL_JULY;
                break;
            case Calendar.AUGUST:
                monthName = MONTH_NAME_FULL_AUGUST;
                break;
            case Calendar.SEPTEMBER:
                monthName = MONTH_NAME_FULL_SEPTEMBER;
                break;
            case Calendar.OCTOBER:
                monthName = MONTH_NAME_FULL_OCTOBER;
                break;
            case Calendar.NOVEMBER:
                monthName = MONTH_NAME_FULL_NOVEMBER;
                break;
            case Calendar.DECEMBER:
                monthName = MONTH_NAME_FULL_DECEMBER;
                break;
            default:
                break;
        }
    ...
    public static String decodeMonthID_EnglishShort(int month) {
        ...
        switch (month) {
            case Calendar.JANUARY:
                monthName = MONTH_NAME_SHORT_JANUARY;
                break;
            case Calendar.FEBRUARY:
                monthName = MONTH_NAME_SHORT_FEBRUARY;
                break;
            case Calendar.MARCH:
                monthName = MONTH_NAME_SHORT_MARCH;
                break;
            case Calendar.APRIL:
                monthName = MONTH_NAME_SHORT_APRIL;
                break;
            case Calendar.MAY:
                monthName = MONTH_NAME_SHORT_MAY;
                break;
            case Calendar.JUNE:
                monthName = MONTH_NAME_SHORT_JUNE;
                break;
            case Calendar.JULY:
                monthName = MONTH_NAME_SHORT_JULY;
                break;
            case Calendar.AUGUST:
                monthName = MONTH_NAME_SHORT_AUGUST;
                break;
            case Calendar.SEPTEMBER:
                monthName = MONTH_NAME_SHORT_SEPTEMBER;
                break;
            case Calendar.OCTOBER:
                monthName = MONTH_NAME_SHORT_OCTOBER;
                break;
            case Calendar.NOVEMBER:
                monthName = MONTH_NAME_SHORT_NOVEMBER;
                break;
            case Calendar.DECEMBER:
                monthName = MONTH_NAME_SHORT_DECEMBER;
                break;
            default:
                break;
        }
    ...
    public static int getMonthIdFromName(String monthName) {
        ...
        if (monthId == UNDEFINED) {
            Set<Entry<Integer, String>> entries = monthNamesShort.entrySet();
            for (Entry<Integer, String> entry : entries) {
                foundShort = monthName.toLowerCase().startsWith(entry.getValue());
                if (foundShort) {
                    monthId = entry.getKey();
                    break;
                }
