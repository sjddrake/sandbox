 ...
 */
public class BreakdownEntityJPATest extends TestCase { //extends PersistenceBaseTestCase {
	...
	public void testBasicUsage() {
		...
		entityManager.getTransaction().begin();
        List result = entityManager.createQuery( "from Breakdown", Breakdown.class ).getResultList();
